...
if (rootElement) {
    const component = initialPayload.mode === 'contabilidad-transfer'
        ? <ContabilidadTransferApp branding={initialPayload.branding || {}} config={initialPayload.contabilidad || {}} />
        : <App branding={initialPayload.branding || {}} tools={initialPayload.tools || []} />;
